...
const parseTeamImg = async (team, length=400) => {
  ...
  for (let i = 0; i < team.members.length; i++) {
    ...
    // Add sample social media links if not present
    if (!member.github && !member.linkedin && !member.instagram) {
      member.github = "https://github.com/sample";
      member.linkedin = "https://linkedin.com/in/sample";
      member.instagram = "https://instagram.com/sample";
    }
  }
}
